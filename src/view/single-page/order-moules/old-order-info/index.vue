  ...
  methods: {
    ...
    search: function(){
      for(let item in this.searchData){
        if(!this.searchData[item] && this.searchData[item] !=0){
        ...
        render: (h, params) => {
          return h('div', [
            h('Button', {
              ...
              style: {
                display: this.authHandle('order_detail') ? 'inline-block' : 'none'
              },
              on: {
                click: () => {
            ...
            //   style: {
            //     marginRight: '5px',
            //     display: (params.row.mainStatus !== 4 && params.row.mainStatus !== 5 && this.authHandle('order_cancel')) ? 'inline-block' : 'none'
            //   },
            //   on: {
            //     click: () => {
            //       this.isShow = true
