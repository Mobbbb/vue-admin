                    ...
                    <TabPane :label="label1" name="0" disabled>
                        <Form ref="formValiInfo" :model="formItem" :rules="ruleValidate" :label-width="130">
                            ...
                            <FormItem label="统一社会信用代码：" prop="orgCode">
                                <Input v-model="formItem.orgCode" placeholder="请输入统一社会信用代码" style="width: 200px" ></Input>
                            </FormItem>
                            <FormItem label="管理员账号：" prop="adminAccount">
                                <Input v-model="formItem.adminAccount" placeholder="请输入管理员账号" style="width: 200px" ></Input><span style="margin-left: 10px;color: #999">请输入手机号，作为管理员登陆账号</span>
                            </FormItem>
                        </Form>
                    </TabPane>
                    <TabPane :label="label2" name="1" disabled>
                        <Form ref="formValiAccout" :model="formItem" :rules="ruleValidate" :label-width="130">
                            ...
                            <FormItem label="授信额度：" prop="creditMoney" v-if="single">
                                <Input v-model="formItem.creditMoney" placeholder="请输入授信额度" :maxlength="10" style="width: 200px" ></Input>
                            ...
                            <div style="width: 200px; ;display: flex;justify-content:space-between">
                                ...
                                <FormItem style="margin-left: -120px"  prop="billDay" >
                                    <Select style="width:90px;" clearable v-model="formItem.billDay" >
                                        <Option v-for="(item,index) of 28 " :value="String(item)" :key="index">{{ item }}号</Option>
                                    </Select>                      
                                </FormItem>
                            </div>
                    ...
                    <TabPane :label="label3" name="2" disabled>
                        <Form ref="formValidate" :model="formItem" :rules="ruleValidate" :label-width="130">
                            <FormItem label="合同：" prop="name">
                                ...
                                :headers="header"
                                >
                                    <Button type="primary" :disabled="formItem.contract.length > 4">上传文件</Button>
                                </Upload>
...
export default {
    ...
    // created() {
    //     this.label1 = this.getLabel("基本信息", "0");
    //     this.label2 = this.getLabel("账户信息", "1");
    //     this.label3 = this.getLabel("其他信息", "2");
    // },
    methods: {
        ...
        getSingle(value) {
            if( value == '2'){
                ...
                console.log(this.formItem.accountType)
