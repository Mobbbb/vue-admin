        ...
        render: (h, params) => {
          ...
          return h('div', [
            h('Button', {
              ...
              style: {
                marginRight: '15px',
                display: (params.row.status === '0' && this.authHandle('customer_block')) ? 'inline-block' : 'none'
              },
              on: {
                click: () => {
                  this.isShow = true
            ...
            h('Button', {
              ...
              style: {
                marginRight: '15px',
                display: (params.row.status !== '0' && this.authHandle('customer_deblockAccountTry')) ? 'inline-block' : 'none'
              },
              on: {
                click: () => {
            ...
            h('Button', {
              ...
              style: {
                display: this.authHandle('customer_detail') ? 'inline-block' : 'none'
              },
              on: {
                click: () => {
