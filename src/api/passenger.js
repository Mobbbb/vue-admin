...
/** 注册活动新增 */
export const activityInsertType = (params) => {
  return axios.request({
    url: '/sys/activity/insertType',
    data: params,
    method: 'POST'
  })
}
...
/** 注册记录列表 */
export const registerRecordList = (params) => {
  return axios.request({
    url: '/sys/activity/registerRecordList',
    data: params,
    method: 'POST'
  })
}
...
/** 优惠券详情 */
export const awardRecord = (params) => {
  return axios.request({
    url: '/sys/activity/awardRecord',
    params,
    method: 'GET'
  })
}
...
/** 推荐乘客新增 */
export const passengersRewardAdd = (params) => {
  return axios.request({
    url: '/sys/passengersReward/insertType',
    data: params,
    method: 'POST'
  })
}
...
/** 推荐乘客新增（司机） */
export const driverRewardAdd = (params) => {
  return axios.request({
    url: '/sys/driverReward/insertType',
    data: params,
    method: 'POST'
  })
}
...
/** 推荐记录列表 */
export const inviteRecoreList = (params) => {
  return axios.request({
    url: '/sys/invite/recoreList',
    data: params,
    method: 'POST'
  })
}
...
/** 充值送规则详情 */
export const rechargeRule = (params) => {
  return axios.request({
    url: '/sys/recharge/lookGiftRulesList',
    params,
    method: 'GET'
  })
}
